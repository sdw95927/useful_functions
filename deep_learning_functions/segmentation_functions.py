...
def get_mask_for_slide_image_tifffile(filePath, display_progress=False):
    ...
    try:
        ...
        '''
        slide_image = np.array(slide.read_region((0, 0), 0, slide.level_dimensions[0]))[..., 0:3]
        zoom = 32
        slide_image = skimage.transform.rescale(slide_image, 1/zoom, preserve_range=True, multichannel=True)
        slide_image = slide_image.astype(np.uint8)
        '''
        pass
